...
IMAGE_RECORD_PATH = os.path.join(MEDIA_DIR, "database", "suspicious_image")
VIDEO_RECORD_PATH = None
IMAGE_SAVE_DIR = os.path.join(MEDIA_DIR, "database", "student_face")
UNRECOGNISED_FACE = os.path.join(MEDIA_DIR, "database", "unrecognised_faces")
UNDETECTED_FACE = os.path.join(MEDIA_DIR, "database", "undetected_face")
MODELS_DIR = os.path.join(MEDIA_DIR, "models")
AIS_MODEL = os.path.join(MODELS_DIR, "aisv1n.pt")
AIS_HEAD_MODEL = os.path.join(MODELS_DIR, "aisv1n.pt")
AIS__MODEL = os.path.join(MODELS_DIR, "ais1v-head.pt")
